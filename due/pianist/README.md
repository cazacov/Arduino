...
<img src="_img/deskjet1200c.jpg?raw=true" alt="Robot playing piano" width="600" height="400"/>

The first step was to remove unnecessary parts, leaving only the motorized frame with the printing head and encoder.
<img src="_img/back.jpg?raw=true" alt="Robot playing piano" width="600" height="400"/>

Ink cartridges where removed and replaced with servo motors and fingers made from LEGO.
<img src="_img/robohand.jpg?raw=true" alt="Robot playing piano" width="600" height="400"/>

All electronics mounted on the moving carriage was removed as well, leaving only the encoder sensor.
<img src="_img/encoder.jpg?raw=true" alt="Robot playing piano" width="600" height="400"/>
...
<img src="_img/hall_sensor.jpg?raw=true" alt="Robot playing piano" width="600" height="400"/>
...
<img src="_img/motor_front.jpg?raw=true" alt="Robot playing piano" width="600" height="400"/>

<img src="_img/motor_rear.jpg?raw=true" alt="Robot playing piano" width="600" height="400"/>

Arduino DUE microcontroller is the "brain" of the robot. DFRduino L298P shield is used to control the motor.

<img src="_img/arduino_due.jpg?raw=true" alt="Robot playing piano" width="600" height="400"/>
...
<img src="_img/debugger.jpg?raw=true" alt="Robot playing piano" width="600" height="400"/>
...
<img src="_img/oscilloscope.jpg?raw=true" alt="Robot playing piano" width="600" height="400"/>
